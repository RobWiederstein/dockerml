...
targets::tar_load(c(
  ...
  tbl_raw_summary_0,
  tbl_raw_summary_1,
  tbl_imputed_summary_0,
  tbl_imputed_summary_1,
  tbl_test_set_results,
  tbl_cm_knn,
  tbl_cm_log_reg,
  plot_raw_missing,
  plot_raw_outliers,
...
This project involves reproducible 0 research with Docker [@nust_rockerverse_2020]. The Pima Indians Diabetes Dataset is a well-known collection of health information frequently used by students and professionals learning data science and machine learning; you'll often find it used in examples on websites like Kaggle. 
...
```{r}
format_table(tbl_test_set_results)
```
